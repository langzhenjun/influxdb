...
func (i *Index) HasTagKey(name, key []byte) (bool, error) {
	// TODO(edd): Check on each Partition?
	return false, nil
}
...
func (i *Index) ForEachMeasurementTagKey(name []byte, fn func(key []byte) error) error {
	// TODO(edd): Apply fn on each Partition.
	return nil
}
